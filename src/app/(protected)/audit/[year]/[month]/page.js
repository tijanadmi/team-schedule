            ...
            <tbody>
              {employees.map((emp) => (
                ...
                >
                  ...
                  <td className="sticky left-0 bg-gray-50 border w-[100px] min-w-[100px] max-w-[100px] px-0.5 sm:px-2 py-0.5 sm:py-1 text-[10px] sm:text-[11px] font-medium text-left text-blue-800 group-hover:bg-blue-100">
                    {emp.full_name}
                  </td>
                  {days.map((d) => {
                    const date = `${year}-${String(month).padStart(2, "0")}-${String(d).padStart(2, "0")}`;
